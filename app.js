...
if (rememberedUser) {
    ...
    if (success) {
        ...
        try {
            ...
            console.log('Auto-login: Updating stats...');
            updateStatsDisplay();
            
            console.log('Auto-login: Rendering packs...');
            await renderPackSelection();
            
            console.log('Auto-login: Rendering stats...');
            await renderStats();
            
            console.log('Auto-login complete');
        } catch (error) {
            console.error('Error during auto-login setup:', error);
        }
    }
}
...
loginButton.addEventListener('click', async () => {
    ...
    if (success) {
        ...
        try {
            ...
            console.log('Rendering pack selection...');
            await renderPackSelection();
            ...
            alert('Error setting up the app. Please try again.');
        }
    } else {
